Algoritmo demoInventario
	...
	Dimension proveedorProducto[100] // guarda �ndice del proveedor y producto
			...
			3:
				...
				SiNo
					...
					SiNo
						...
						Escribir ""
						Escribir "---- Proveedor registrado con �xito ----"
						Escribir ""
					FinSi
				FinSi
			...
			5:
				...
				Sino
					...
					Si posicion >= 1 Y posicion <= numeroProductos Entonces
						...
						FinSi
					Sino
						Escribir "Error: El numero de producto no es v�lido"
					FinSi
				FinSi
